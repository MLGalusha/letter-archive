...
Single `createImageBitmap` decode samples for original / 480px WebP / 1200px WebP were 53 / 2.4 / 9.3ms in Chromium and 78 / 10 / 11ms in WebKit. These are local desktop-engine samples, not phone CPU, battery, production latency, LCP or p95 results. The browser has discretion over responsive candidate selection, caching, lazy-load distance and retries.

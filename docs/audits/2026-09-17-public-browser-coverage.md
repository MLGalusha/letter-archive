...
For #24, Collection 009’s Jimmie popup was checked at 390×844 in both engines against the local frontend and public read-only data. Its existing body portal spans x/y=0, width390, height844; hit-testing the top/bottom edges selects the overlay. This overlaps the previously closed collection-specific issue #41. It does not confirm the letter-page trigger named in #24 or close that report without knowing the affected control.

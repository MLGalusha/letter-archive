...
## 7. Transcript edge spacing

**Status: issue 22 candidate reviewed in Chromium/WebKit; deployment and phone checks pending.** [Issue 22](https://github.com/MLGalusha/letter-archive/issues/22).
...
- Expected: reading text has visible space on both sides instead of reaching the right edge. Switch to Original formatting and back; both modes remain readable. The change adjusts spacing only.

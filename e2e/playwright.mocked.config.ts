...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'public-webkit',
      testMatch: ['public-archive-history.mocked.spec.ts', 'progressive-image-scheduling.mocked.spec.ts', 'reader-renditions.mocked.spec.ts', 'public-request-ownership.mocked.spec.ts'],

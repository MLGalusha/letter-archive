...
export function InlineScanNavigation({ images, selected, onSelect, motion }: {
  ...
  return <div className="scan-navigation">
    ...
    <ViewerPageDrawer id={drawerId} images={images} selected={selected} onSelect={onSelect} motion={motion} layout="inline" />
  </div>;
}

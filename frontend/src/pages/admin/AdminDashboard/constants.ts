...
export const ALL_COLUMNS: ColumnDef[] = [
  ...
  { id: "collection", label: "Collection", group: "core", defaultVisible: true },
  { id: "visibility", label: "Visibility", group: "core", defaultVisible: true },
  { id: "flag", label: "Review flag", group: "core", defaultVisible: true },
  { id: "transcript", label: "Transcript status", group: "workflow", defaultVisible: true },
  { id: "metadata", label: "Metadata status", group: "workflow", defaultVisible: true },
  { id: "lastOpened", label: "Last opened", group: "admin", defaultVisible: true },
  { id: "created", label: "Uploaded", group: "admin", defaultVisible: false },
  { id: "updated", label: "Last updated", group: "admin", defaultVisible: false },
  { id: "letters", label: "Letter pages", group: "counts", defaultVisible: true },
  { id: "extras", label: "Extra items", group: "counts", defaultVisible: true },
  { id: "photos", label: "Photo items", group: "counts", defaultVisible: false },
  { id: "type_letter", label: "Letter files", group: "contentTypes", defaultVisible: false },
  { id: "type_cover", label: "Cover files", group: "contentTypes", defaultVisible: false },
  { id: "type_telegram", label: "Telegram files", group: "contentTypes", defaultVisible: false },
  { id: "type_photo", label: "Photo files", group: "contentTypes", defaultVisible: false },
  { id: "type_card", label: "Card files", group: "contentTypes", defaultVisible: false },
  { id: "type_ephemera", label: "Ephemera files", group: "contentTypes", defaultVisible: false },
  { id: "type_voice", label: "Voice files", group: "contentTypes", defaultVisible: false },
  { id: "type_article", label: "Article files", group: "contentTypes", defaultVisible: false },
  { id: "type_diary", label: "Diary files", group: "contentTypes", defaultVisible: false },
];
